...
<Grid item xs={12}>
    <Tooltip title={plant.is_sugar_production_on ? "Turn off Sugar Production" : "Turn on Sugar Production"}>
      ...
      flexWrap: "wrap",
        ...
        <Water amount={photosynthesisWaterConsumption(plant.maturity_level)} />/s + <Sunlight amount={photosynthesisSunlightConsumption(plant.maturity_level)} />/s <ArrowForwardIcon sx={{color:plant.is_sugar_production_on?"":"red"}} />   <Sugar amount={photosynthesisSugarProduction(plant, plantTime.season)} />/s
            </Box>
